...
def TrainBasicModel(epochs=10,batch_size=32,save_path=None):
	ListOfBoardDicts = utils.readBoards("assets/gensim_board_list.json")
	Input = []
...
def Inference(board):
	...
	googlemodel = gensim.models.KeyedVectors.load_word2vec_format('./assets/GoogleNews-vectors-negative300.bin', binary=True, limit=10000)
...
TrainBasicModel(epochs=10)
ListOfBoardDicts = utils.readBoards("./assets/gensim_dev_board_list.json")
ListOfBoardDictsWords = utils.readWordBoards("./assets/gensim_dev_board_list.json")
